            ...
            <div className="px-6 py-4 m-1 social_icons">
                <button
                    ...
                    <svg
                        ...
                        <circle cx="16" cy="32" r="5" fill="url(#stMYITnsBzu7K9XzUdIHAa)" />
                        <g>
                            <linearGradient
                                id="stMYITnsBzu7K9XzUdIHAb"
                                x1="31.998"
                                x2="31.998"
                                y1="3.425"
                                y2="51.347"
                            ...
                            <path
                                fill="url(#stMYITnsBzu7K9XzUdIHAc)"
                                d="M48,21c1.336,0,2.592-0.521,3.535-1.465C52.479,18.592,53,17.336,53,16 s-0.521-2.592-1.465-3.535C50.592,11.521,49.336,11,48,11s-2.592,0.521-3.535,1.465C43.521,13.408,43,14.664,43,16 s0.521,2.591,1.465,3.535S46.664,21,48,21z M45.879,13.879C46.445,13.313,47.198,13,48,13s1.555,0.313,2.121,0.879S51,15.198,51,16 s-0.313,1.555-0.879,2.121c-1.133,1.133-3.109,1.133-4.242,0C45.313,17.555,45,16.802,45,16S45.313,14.445,45.879,13.879z"
                            />
                            <linearGradient
                                id="stMYITnsBzu7K9XzUdIHAd"
                                x1="48"
                                x2="48"
                                y1="3.425"
                                y2="51.347"
                            ...
                            <path
                                fill="url(#stMYITnsBzu7K9XzUdIHAd)"
                                d="M51.535,44.465C50.592,43.521,49.336,43,48,43s-2.591,0.521-3.535,1.465S43,46.664,43,48 s0.521,2.592,1.465,3.535C45.408,52.479,46.664,53,48,53s2.592-0.521,3.535-1.465C52.479,50.592,53,49.336,53,48 S52.479,45.408,51.535,44.465z M50.121,50.121c-1.133,1.133-3.109,1.133-4.242,0C45.313,49.555,45,48.802,45,48 s0.313-1.555,0.879-2.121S47.198,45,48,45s1.555,0.313,2.121,0.879S51,47.198,51,48S50.688,49.555,50.121,50.121z"
                            />
                        </g>
                    </svg>
                </button>
