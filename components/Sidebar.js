...
function Sidebar({ classname }) {
    ...
    return (
        <div
            className={`${classname} sticky top-14 md:top-24 h-screen inline col-span-1 bg-blue-50 md:bg-transparent dark:bg-black md:dark:bg-transparent sm:left-0 z-10 p-0 md:p-2 ${styles.sidebar_in_mobile}`}>
